...
\mode<presentation>{%
	{%
		\usebackgroundtemplate{\includegraphics[width=\paperwidth]{California-fire.jpg}}
		\setbeamercolor{frametitle}{bg=black}
		\setbeamercolor{normal text}{fg=white}
		\usebeamercolor*{normal text}
		\setbeamercolor{structure}{fg=white!80!black}
		\begin{frame}[t,plain]{California is Burning}
			...
			\begin{footnotesize} Ringo H.W. Chiu/AP \end{footnotesize}
		\end{frame}
	}
}

\frame{\section{Substances and Compounds}
...
\begin{frame}{A Particulate View of the World}
...
\begin{frame}{The Law of Conservation of Mass}
	...
	\begin{overlayarea}{\linewidth}{10em}
		\only<1>{\includegraphics[width=\linewidth]{conservemass-mcmurry.jpg}}
...
\begin{frame}{The Discovery of the Electron}
	...
	\begin{center}
		\includegraphics[width=\linewidth]{cathode-tube-mcmurry.jpg}
	\end{center}
\end{frame}

\begin{frame}{What charge are electrons?}{Millikan's oil drop experiment}
	\begin{center}
		\includegraphics[width=\linewidth]{millikan-mcmurry.jpg}
	\end{center}
\end{frame}
...
\begin{frame}{An Electron-Centric Atomic Structure}
	...
	\begin{tabularx}{\linewidth} {X@{\qquad}X}
		\includegraphics[width=\linewidth]{superb-english-plum-pudding.jpg}

		\tiny\url{https://www.epicurious.com/}
		& \includegraphics[width=\linewidth]{plumpudding.jpeg} \\
	\end{tabularx}
\end{frame}
...
\begin{frame}{The Discovery of the Nucleus}
	...
	\begin{center}
		\includegraphics[width=\linewidth]{rutherford-mcmurry.jpg}
	\end{center}
\end{frame}
...
\begin{frame}{So\ldots\ What is an atom?}
	...
	\includegraphics[width=\linewidth]{atom-mcmurry.jpg}
\end{frame}
...
\begin{frame}{Subatomic Particles}
	\begin{center}
		...
		\begin{tabular} {@{}l S[table-format=1.5e-2]
			...
			\bottomrule
			\multicolumn{4}{p{4in}}{\footnotesize *Atomic Mass Units (amu) -- a mass exactly equal to
...
\begin{frame}{Isotopes and Average Mass}
	...
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\draw[<-,ultra thick,primary] (35) to ++(-2,0) node[left,font=\sffamily,align=right,text
...
\begin{frame}{What about the electrons?}{Ionization}
	\only<1>{In order to keep atoms and molecules \alert{neutral}, the number of
	...
	\only<2->{Atoms (or molecules) can \alert{gain} or \alert{lose} electrons
