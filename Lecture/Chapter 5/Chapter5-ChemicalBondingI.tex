...
\begin{frame}[t]{Expanded Octets}
	...
	What is the Lewis structure for \ch{H2SO4}?
	...
	\note{How do we know which structure is correct experimentally?}

\end{frame}

\begin{frame}[t]{Incomplete Octets}
	Boron does not require a complete octet for an appropriate Lewis
	structure.

	\bigskip

	\begin{example}
		Draw the Lewis structure for \ch{BF3}.
	\end{example}

	\note{%
		For a compound such as \ch{BF3}, we \alert{could} create a
		double bond to form a complete octet around boron.

			\begin{center}
				\includegraphics[scale=0.1]{05_Pg218_UnFigure_2.jpg}
				\qquad\includegraphics[scale=0.1]{05_Pg218_UnFigure_3.jpg}
			\end{center}
		This would create a positive formal charge on \ch{F},
			which is \alert{very unfavorable}.
		}

\end{frame}

\begin{frame}{Textbook Errata}
\begin{center}
	\includegraphics[width=0.9\linewidth]{05_Pg218_UnFigure_1.jpg}

	This figure is wrong on pg. 218
	of your textbook!
\end{center}
\end{frame}
...
\begin{frame}{Free Radicals}
	...
	\begin{columns}
		...
		\column{0.45\linewidth}
		\centering
		\includegraphics[scale=0.12]{ozone-hole.png}
		\begin{example}
...
\begin{frame}[t]{Bond Energies Example}
	...
	\begin{itemize}
		\item \chemfig{[,0.75]C-C} \note[item]{\SI{347}{\kilo\joule\per\mole}}
		\item \chemfig{[,0.75]C=C} \note[item]{\SI{611}{\kilo\joule\per\mole}}
		\item \chemfig{[,0.75]C~C} \note[item]{\SI{837}{\kilo\joule\per\mole}}
	\end{itemize}
\end{frame}
...
\begin{frame}[t]{Bond Lengths Example}
	...
	\begin{itemize}
		\item \chemfig{[0,0.75]H-F}~  \note[item]{\SI{92}{\pico\meter}}
		\item \chemfig{[0,0.75]H-Cl}  \note[item]{\SI{127}{\pico\meter}}
		\item \chemfig{[0,0.75]H-Br}  \note[item]{\SI{141}{\pico\meter}}
		\item \chemfig{[0,0.75]H-I}~  \note[item]{\SI{161}{\pico\meter}}
	\end{itemize}
\end{frame}
