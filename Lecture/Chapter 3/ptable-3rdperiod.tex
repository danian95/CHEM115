...
%% Actinide
  ...
  \path (Be.north east) -- (B.north west) node[midway,draw,text width=5in,align=center,font=\fontsize{60pt}{60pt}\selectfont\bfseries,inner sep=2em,color=primary] {All have \ch{[Ne]} ($\bm{1s^22s^22p^6}$)!};
